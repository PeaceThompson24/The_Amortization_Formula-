...
3. SYSTEM DESIGN:Here I planned how the program will work.The program needs a function for the amortization formula.It should take user inputs.It should calculate the
...
5. IMPLEMENT:This is where I wrote the actual Python code based on my design.I created a function called
...
*under this function, this particular variables is converted to months*,

LOAN DURATION(years)(n)]
